...
export const initialNodes: Node<ModelNodeData>[] = [
  ...
  // policy
  { id: "PolicyRuleResource",           type: "model", position: { x: 0, y: 0 }, data: { ns: "policy", label: "PolicyRuleResource",           fields: [{ name: "id / name", type: "string" }, { name: "action", type: "string" }, { name: "disabled", type: "\"0\"|\"1\"" }, { name: "priority", type: "string" }, { name: "conditions", type: "Conditions[]" }] } },
